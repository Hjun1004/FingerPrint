...
public class EventLogBkDto {
    ...
    // 생성자 (모든 필드 초기화)
    public EventLogBkDto(int nEventlogIdn, int nDateTime, int nReaderIdn, int nEventIdn, int nUserID,
    ...
    // 엔티티 → DTO 변환 메서드
    public static EventLogBkDto fromEntity(EventLog eventLog) {
        return new EventLogBkDto(
